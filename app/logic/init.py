...
from infra.repositories.messages.mongo import MongoDBChatRepository, MongoDBMessageRepository
...
def _init_container() -> Container:
    ...
    container.register(
        BaseMessageRepository, factory=init_message_mongodb_repository, scope=Scope.singleton
    )
